...
function initCheckbox(checkboxId, titlebar_name, titlebar_icon_url, titlebar_text) {
  var elem = document.getElementById(checkboxId);
    addTitlebar("top-titlebar", "./assets/images/top-titlebar.png", "");
    focusTitlebars(true);
    updateContentStyle();
    updateCheckbox();
...
window.onload = function() {  
  initCheckbox("top-box", "top-titlebar", "./assets/images/top-titlebar.png", "Top Titlebar");
//   initCheckbox("bottom-box", "bottom-titlebar", "./assets/images/bottom-titlebar.png", "Bottom Titlebar");
//   initCheckbox("left-box", "left-titlebar", "./assets/images/left-titlebar.png", "Left Titlebar");
//   initCheckbox("right-box", "right-titlebar", "./assets/images/right-titlebar.png", "Right Titlebar");
